...
st.set_page_config(
    ...
    page_icon="https://raw.githubusercontent.com/dearamires/previsao-renda/main/ebac-course-utils/media/icon/favicon.ico",
    layout="wide",
...
with st.sidebar.expander("Bibliotecas/Pacotes", expanded=False):
    ...
    st.markdown('# <div style="text-align:center"> [Previsão de renda](https://github.com/dearamires/previsao-renda) </div>',
            unsafe_allow_html=True)
...
with st.expander("Visualização impressao da árvore", expanded=False):
